...
log_level = 'INFO'
load_from = "work_dirs/imvoxelnet_scannet_fast_cov_w_mean_volume_renderrgb_image_mode_524_resnet50_onlyrgb_2x_low_res_nerfrpntraining/latest.pth"
resume_from = None
workflow = [('train', 1)]
